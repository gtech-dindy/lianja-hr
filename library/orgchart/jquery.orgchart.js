    ...
    function Node(data){
        ...
        this.formatNode = function(opts){
            ...
            if(typeof data.description !== 'undefined'){
                descString = '<p class="ui-lianja-p-nomargin-before">'+self.data.description+'</p>';
            }
			...
			if (typeof data.backcolor !== 'undefined' && data.backcolor.length>0)
			{
				backcolor = data.backcolor;
				style = "background:" + backcolor + "!important;"
			}
			if (typeof opts.nodeWidth !== 'undefined') width = opts.nodeWidth;
			style = style + "width:" + width + ";";
			return "<div class='node' node-id='"+this.data.id+"' style='" + style + "'>"+nameString+descString+buttonsHtml+"</div>";
        }
    }
