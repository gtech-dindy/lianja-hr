                    ...
                    if (hStyle == '2d') {
                        ...
                        */
                        ...
                        context.beginPath();
                            ...
                            context.arc(segment[0], segment[1], segment[2] / 2, obj.angles[segment[5]][1], obj.angles[segment[5]][0], true);
                        context.stroke();
                        context.fill();
                        ...
                        context.beginPath();
                            ...
                            context.arc(segment[0] - 3, segment[1] - 3, segment[2] / 2, obj.angles[segment[5]][1], obj.angles[segment[5]][0], true);
                        context.closePath();
    ...
    */
    ...
    {
        if (this.Get('chart.linewidth') > 0 && 0) {
